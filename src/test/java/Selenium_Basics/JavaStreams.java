...
public class JavaStreams {
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(800);
		/*
		 * Here the below lines of code extracts the web elements using the xpath the
		 * using java streams it gets the web elements text and stores in List then it
		 * is sorted
		 */
		...
		do {
			...
			price = rows.stream().filter(s -> s.getText().contains("Rice")).map(JavaStreams::getPriceVeggie)
